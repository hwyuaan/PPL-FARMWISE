      ...
      <aside id="default-sidebar" class="flex top-0 left-0 w-64 transition-transform " aria-label="Sidebar">
         <div class="px-3 py-28 overflow-y-auto bg-gray-50 dark:bg-green-400">
            <ul class="space-y-5 font-medium py-8">
              ...
              <li>
                 <a href="/datapegawai" class="flex items-center p-2 text-neutral-950 rounded-lg dark:text-neutral-950 hover:bg-gray-100 dark:bg-green-100 group">
                     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" />
                     </svg>                   
                     <span class="flex-1 ms-3  text-neutral-950 ">Data Pegawai</span>
                  </a>
              </li>
              <li>
      ...
      <div class="flex flex-col mt-24 w-full pr-10">
         <div class="flex flex-row items-center text-center py-4 justify-between w-full">
            <div class="flex flex-row">
               <h1 class="text-neutral-900 font-normal text-2xl pr-10 ">Daftar Pegawai</h1>
               <a href="/tambahpegawai" class="button bg-green-400 w-40 h-10 text-white font-semibold text-xl rounded-lg flex justify-center items-center"> 
               ...
               <table class="table text-black border-separate space-y-6 text-sm w-full font-semibold">
                 ...
                 <tbody>
                     ...
                     <tr class="bg-gray-200">
                         ...
                         <td class="p-3">
                           <a href="{{ url('/formubahpegawai', ['id' => $user->id]) }}" class="button bg-green-400 w-20 h-8 text-white font-semibold text-l rounded flex-row justify-center items-center m-1">Edit</a>
                           <a href="{{ url('/hapuspegawai', ['id' => $user->id]) }}" class="button bg-red-500 w-20 h-8 text-white font-semibold text-l rounded flex-row justify-center items-center m-1">Hapus</a>
                         </td>
